    ...
    return <div className="w-full h-full flex justify-center items-center select-none">
        <div className="w-[450px] border p-8 mt-32 bg-blue-600 text-white rounded-lg hover:shadow-lg">
            ...
            <div className='w-full flex justify-center mt-[50px]'>
                <button className='w-[200px] p-2 rounded bg-white-200 border text-black hover:bg-gray-500 hover:text-white' onClick={handleSignIn}>Sign-in</button>
            </div>
            ...
            <div className='w-full flex justify-center text-[14px]'>Do not have an account? <span className='ml-2 text-gray-300 hover:text-white cursor-pointer' onClick={()=>location.href="/signup"}>Sign Up</span></div>
        </div>
    </div>
}